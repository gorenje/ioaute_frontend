...
- (id)initWithFrame:(CGRect)aFrame
{
    ...
    if (self)
    {
        ...
        [self setSubviews:[tweetBackground, authorName, timeSinceTweet, tweetText, authorAvatarView]];
    }
...
- (void)setObjectValue:(id)aTweet
{
    ...
    var tweetDate = new Date([tweet createdAt]);
    ...
    [tweetText setStringValue:[tweet text]];
    ...
    var userImage = [[CPImage alloc] initWithContentsOfFile:[tweet profileImageUrl]
